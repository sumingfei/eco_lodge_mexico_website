...
export const developerSegments: { title: L; text: L }[] = [
  ...
  { title: W("Desarrollos para renta vacacional", "Vacation-rental developments"), text: W("Conjuntos de NIDO para operación tipo Airbnb con costos y tiempos por unidad claros.", "NIDO clusters for Airbnb-style operation with clear per-unit costs and timelines.") },
