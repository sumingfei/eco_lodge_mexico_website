...
export const projects: Project[] = [
  ...
  { slug: "casa-de-luz", title: W("Casa de luz", "House of light"), region: "Ciudad", location: "Querétaro, Querétaro", model: "casa-150", modelName: "CASA 150", areaM2: 150, image: "/images/projects/ciudad-01.jpg", alt: W("Casa blanca minimalista con jardín frontal", "Minimalist white house with front garden"), status: "concept", size: "wide" },
  { slug: "celosia-del-desierto", title: W("Celosía del desierto", "Desert screen"), region: "Desierto", location: "Hermosillo, Sonora", model: "casa-150", modelName: "CASA 150", areaM2: 150, image: "/images/projects/desierto-02.jpg", alt: W("Casa con celosía metálica perforada iluminada al anochecer", "House with perforated metal screen lit at dusk"), status: "concept" },
  { slug: "casa-palmar", title: W("Casa palmar", "Palm house"), region: "Costa", location: "Mérida, Yucatán", model: "villa-200", modelName: "VILLA 200", areaM2: 200, image: "/images/projects/costa-02.jpg", alt: W("Casa blanca con terraza, palmera y alberca", "White house with terrace, palm tree and pool"), status: "concept" },
  { slug: "casa-de-piedra", title: W("Casa de piedra", "Stone house"), region: "Campo", location: "Tequisquiapan, Querétaro", model: "casa-110", modelName: "CASA 110", areaM2: 110, image: "/images/projects/campo-01.jpg", alt: W("Casa con zócalo de piedra y recubrimiento de madera", "House with stone plinth and timber cladding"), status: "concept", size: "wide" },
  { slug: "casa-en-el-bosque", title: W("Casa en el bosque", "House in the forest"), region: "Bosque", location: "Mazamitla, Jalisco", model: "casa-110", modelName: "CASA 110", areaM2: 110, image: "/images/projects/bosque-02.jpg", alt: W("Cabaña de madera con grandes ventanales en el bosque", "Timber cabin with large windows in the forest"), status: "concept" },
  { slug: "casa-patio-urbano", title: W("Patio urbano", "Urban courtyard"), region: "Ciudad", location: "Guadalajara, Jalisco", model: "villa-200", modelName: "VILLA 200", areaM2: 200, image: "/images/projects/ciudad-02.jpg", alt: W("Casa gris con celosía de madera en contexto urbano", "Grey house with timber screen in an urban setting"), status: "concept" },
];
